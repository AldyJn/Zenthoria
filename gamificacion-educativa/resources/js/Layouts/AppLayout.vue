    ...
    >
      ...
      <v-list density="compact" nav>
        ...
        <v-list-group value="clases">
          ...
          <v-list-item
            v-if="$page.props.auth.user.es_docente"
        ...
        <!-- Gamificación -->
        <v-list-group value="gamificacion" v-if="!$page.props.auth.user.es_docente">
          <template v-slot:activator="{ props }">
            <v-list-item
              v-bind="props"
        ...
        <v-list-group value="gestion" v-if="$page.props.auth.user.es_docente">
          <template v-slot:activator="{ props }">
            <v-list-item
              v-bind="props"
          ...
          <v-list-item
            ...
            :to="route('tipo-comportamiento.index')"
          ></v-list-item>
        </v-list-group>
...
const userRole = computed(() => {
  return window.$page.props.auth.user.es_docente ? 'Docente' : 'Estudiante';
});
